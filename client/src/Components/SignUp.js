            ...
            focus:ring-opacity-50"
              ...
              <div class="col-span-6 sm:col-span-3">
                ...
                <input
                  ...
                  class="mt-1 w-full h-10 p-5 outline-none rounded-md border-gray-200 bg-white text-sm text-gray-700 shadow-sm focus:border-indigo-300 focus:ring  focus:ring-indigo-200 focus:ring-opacity-50"
                />
                <p className=" mt-3 text-red-500">
